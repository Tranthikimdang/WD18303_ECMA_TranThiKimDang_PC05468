    ...
    productService.fetchData('http://localhost:3000/category').then(data => {
        data.forEach(function (item, index) {
            ...
            tr.innerHTML = `
                ...
                <td>
                    <button class="openEditPage" data-id="${item.idcategory}">Sửa</button>
                    <button class="deletePro" data-id="${item.idcategory}">Xóa</button>
                </td>
            `;
...
// }
// var hotdeal = 0;
// document.querySelector('#hotdeal').addEventListener('change', function () {
//     if (this.checked) {
//         hotdeal = 1;
//     } else {
//         hotdeal = 0;
